...
\normalfont{My research interest lies in data-driven methods for stochastic dynamical system. In particular, I am interested in building up theoretical framework for learning stochastic Koopman operator and applying it into complex real-world problems, e.g., neurodynamics, reinforcement learning and generative diffusion modeling, etc.}
...
\begin{enumerate}
    ...
    Alan Turing Institute, London, UK, January 8th, 2026 (Online)
    
    \item {\sl Data-Driven Koopman Framework for Modeling Complex Dynamical Systems} \\
    Fudan University, Shanghai, China, January 5th, 2026
    
    \item {\sl Data-Driven Koopman Framework for Modeling Complex Dynamical Systems} \\
    European Molecular Biology Laboratory, Rome, Italy, November 24th, 2025 (Online)
    
    \item {\sl Data-Driven Koopman Framework for Modeling Complex Dynamical Systems} \\
    Laboratoire Hubert Curien, Saint-Étienne, France, October 14th, 2025
...
\section{Visiting}
\begin{enumerate}
    \item University of Oregon, OR, April ({\it upcoming}) 
    \item MIT, MA, April ({\it upcoming})
    \item Fudan University, China, January 5-9th, 2026
