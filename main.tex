...
September 2021 - August 2025(Expected)
%\hfill GPA: 3.88/4.0\\
...
\normalfont{My research interest lies in data-driven methods for stochastic dynamical system. In particular, I am interested in building up theoretical framework for learning stochastic Koopman operator and applying it into complex real-world problems. Recently I am also interested in applying Koopman operator theory to generative diffusion modeling.}
...
\begin{enumerate}
    ...
    \item ResKoopNet: Learning Koopman Representations for Complex Dynamics with Spectral Residuals (\href{https://icml.cc/virtual/2025/poster/45196}{ICML (poster)}, Vancouver, Canada, 2025)
